...
public class BookServiceImplTest {
    ...
    public void setUp() {
        ...
        testBook = new Book(1L, "Test Book", "Test Author", "2025", 5, "Phil Fernandez", "My First Review");
        testBook.setId(1L);
    }
    ...
    @Test
    void updateBook() {
        Book updatedBook = new Book(1L, "Updated Test Book", "Test Author", "2025", 4, "Phil Fernandez", "My Updated Review");
